...
public class CrusherScreen extends HandledScreen<CrusherScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(GiantPotato.MOD_ID, "textures/gui/crusher/crusher.png");
    private static final Identifier MASH_TEXTURE =
            Identifier.of(GiantPotato.MOD_ID, "textures/gui/crusher/mash_bar.png");
    private static final Identifier PROGRESS_TEXTURE =
            Identifier.of(GiantPotato.MOD_ID, "textures/gui/crusher/progress.png");
    ...
    private void renderProgressArrow(DrawContext context, int x, int y) {
        if(handler.isCrafting()){
            context.drawTexture(PROGRESS_TEXTURE, x + 75, y + 34, 0, 0,
