...
public class PoisonousMashFluidRenderHandler implements FluidRenderHandler {
    ...
    public void reloadTextures(SpriteAtlasTexture textureAtlas) {
        sprites[0] = textureAtlas.getSprite(Identifier.of(GiantPotato.MOD_ID, "block/poisonous_mash_liquid"));
        sprites[1] = textureAtlas.getSprite(Identifier.of(GiantPotato.MOD_ID, "block/poisonous_mash_liquid_falling"));
    }
}
